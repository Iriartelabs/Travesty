...
def process_trading_data(orders_path, trades_path, tickets_path):
    ...
    try:
        ...
        for col in ['qty', 'lvsqty', 'price', 'stopprice', 'trailprice']:
        ...
        for col in ['qty', 'price', 'commission', 'RouteFee']:
        ...
        if order_id in trades_by_order.groups:
            ...
            for _, trade in order_trades_df.iterrows():
                ...
                if trade_id in tickets_dict:
                    ...
                    trade_dict['commission'] = safe_float(ticket['commission'])
                    trade_dict['routeFee'] = safe_float(ticket['RouteFee'])
                else:
