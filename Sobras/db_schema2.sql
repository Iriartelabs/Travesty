-- Script de inicialización para la base de datos de DAS Trader Analyzer
-- Ejecutar este script directamente en MySQL para crear la base de datos y tablas
...
-- Procedimientos almacenados para importación y análisis
DELIMITER //

-- Procedimiento para importar órdenes desde una tabla temporal
...
-- Procedimiento para importar trades desde una tabla temporal
...
BEGIN
    ...
    FROM 
        temp_table_name t
        JOIN traders tr ON t-- Script de inicialización para la base de datos de DAS Trader Analyzer
-- Ejecutar este script directamente en MySQL para crear la base de datos y tablas
...
CREATE TABLE IF NOT EXISTS routes (
    route_id INT AUTO_INCREMENT PRIMARY KEY,
    route_name VARCHAR(20) NOT NULL,
    UNIQUE KEY unique_route (route_name).Trader = tr.trader_name;
...
-- Procedimiento para importar tickets desde una tabla temporal
    ...
    symbol_metrics AS (
        SELECT 
            ...
            JSON_OBJECT(
                ...
                'buy_count', SUM(CASE WHEN pnl > 0 AND o
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS routes (
    route_id INT AUTO_INCREMENT PRIMARY KEY,
    route_name VARCHAR(20) NOT NULL,
    UNIQUE KEY unique_route (route_name).side = 'B' THEN 1 ELSE 0 END),
...
INSERT IGNORE INTO symbols (symbol) VALUES 
('AAPL'), ('MSFT'), ('GOOGL'), ('AMZN'), ('META'), 
('NVDA'), ('TSLA'), ('AMD'), ('NFLX'), ('PYPL');

INSERT IGNORE INTO traders (trader_name) VALUES ('TRADER1');

INSERT IGNORE INTO routes (route_name) VALUES 
('SMART'), ('NYSE'), ('ARCA'), ('NSDQ'), ('BATS');

-- Mensaje de finalización
SELECT 'Base de datos inicializada correctamente' AS 'Status';
.Trader = tr.trader_name;
